      ...
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="header-heading">
            ...
            <a href="service_web" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">More Details <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          </div>
        </div>
        <div class="col-lg-6 v-center">
  ...
  <div class="container">
    ...
    <div class="row upset link-hover shape-num justify-content-center">
      <div class="col-lg-3 col-sm-6 mt30 shape-loc wow fadeInUp" data-wow-delay="0.2s">
        <div class="s-block" data-tilt data-tilt-max="5" data-tilt-speed="1000">
          ...
          <a href="service_web">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
        </div>
      </div>
    ...
    <div class="-cta-btn mt70">
      <div class="free-cta-title v-center wow zoomInDown" data-wow-delay=".9s">
        ...
        <a href="pricing" class="btn-main bg-btn2 lnk">Packages<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
      </div>
    </div>
  </div>
</section>
