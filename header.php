...
<head>
	<meta charset="utf-8"/>
	<title>AWEDES - Web Design &amp; We Create Awesomeness  </title>
...
<body class="active-dark">
	...
	<div class="onloadpage" id="page_loader">
		<div class="pre-content">
			...
			<div class="pre-text-"><span>AWEDES - We Create Awesomeness.</span>Have Patience</div>
		</div>
	</div>
	<!--End Preloader -->
	<!--Start Header -->
		...
		<div class="container-fluid m-pad">
			<div class="menu-header">
				...
				<div class="custom-nav" role="navigation">
					<ul class="nav-list">
						<li><a href="home" class="menu-links text-radius text-light text-animation bg-b">Home</a></li>
								...
								<div class="sub-menu-section">
									<div class="container">
										<div class="sub-menu-center-block">
											...
											<div class="sub-menu-column">
											<div class="menuheading">Marketing</div>
												<ul>
													<li><a href="marketing">Digital marketing</a></li>
													<li><a href="Infu_marketing">infulencer marketing </a></li>	
												</ul>
											</div>
											<div class="sub-menu-column">
											<div class="menuheading"> designing</div>
												<ul>
													<li><a href="design">designing and printing</a></li>
													<li><a href="interior_design">Interior design</a></li>
												</ul>
											</div>
											<div class="sub-menu-column">
											<div class="menuheading">Montage</div>
												<ul>
													<li><a href="photography">Photography and Video Editing </a></li>
												</ul>
											</div>
						...
						<li class="sbmenu"><a href="about" class="menu-links">About</a>
							<div class="nx-dropdown">
									<div class="sub-menu-section">
										<div class="container">
											<div class="sub-menu-center-block">
												...
												<div class="sub-menu-column">
												<div class="menuheading">Who We Are</div>
												<ul>
												...
												<div class="sub-menu-column">
												<div class="menuheading">Why Us</div>
												<ul>
					...
					<li><a href="pricing" class="menu-links">Packages</a>
					<li><a href="contact" class="menu-links">Contact us</a>
				</li>
					...
					<li class="contact-show"><a href="#" class="btn-round- trngl btn-br bg-btn"><i class="fas fa-phone-alt"></i></a>
						<div class="contact-inquiry">
							<div class="contact-info-">
								<div class="contct-heading">AWEDES Contacts</div>
								...
								<div class="inquiry-card-nn">
									...
									<ul><li><a href="tel:1111111111"><img src="images/flags/us.svg" alt="us office" class="flags-size"> +1-123-456-7890</a></li>
										...
										<li><i class="fab fa-skype"></i><a href="skype:AWEDES.company?call" >AWEDES.company</a></li>
										<li><i class="fas fa-envelope"></i><a href="mailto:info@businessname.com" >info@businessname.com</a></li></ul>
									</div>
								</div>
							</div>
						</li>
						<li><a href="get-quote.html" class="btn-br bg-btn3 btshad-b2 lnk">Arabic <span class="circle"></span></a> </li>
					</ul>
				</div>
			...
			<nav id="main-nav">
				...
				<ul class="bottom-nav">
					...
					<li class="prb">
						<a href="skype:AWEDES.company?call">
