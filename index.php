				...
				<div class="row">
					<div class="col-lg-5">
						<div class="hero-heading-sec">
							...
							<a href="agency_dtls" class="btn-main bg-btn lnk wow fadeIn"  data-wow-delay="0.8s">Let’s Start The Journey <i class="fas fa-chevron-right fa-ani"></i><span class="circle"></span></a>
						</div>
					</div>
					<div class="col-lg-7">
				...
				<div class="container">
					...
					<div class="-cta-btn mt70">
						<div class="free-cta-title v-center zoomInDown wow" data-wow-delay="1.4s">
							<p> Our Package for you<span> Join Now</span></p>
							<a href="contact" class="btn-main bg-btn2 lnk"> Contact Us Now <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="common-heading text-l">
								...
								<h2 class="mb20">Why The AWEDES <span class="text-second text-bold">Ranked Top</span> Among The Leading Web & App Development Companies</h2>
			...
			<section class="testinomial-section bg-none pad-tb">
				<div class="container">
					<div class="row justify-content-center ">
						<div class="col-lg-8">
							<div class="common-heading">
								<span>What our clients say about AWEDES.</span>
							...
							<div class="row justify-content-center">
								<div class="col-lg-8">
									<div class="common-heading">
										...
										<a href="contact" class="btn-outline">Estimate Project <i class="fas fa-chevron-right fa-icon"></i></a>
										<p class="cta-call">Or call us now <a href='contact'><i class="fas fa-phone-alt"></i></a></p>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="container">
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="footer-">
												<p>Copyright &copy; 2020 AWEDES. All rights reserved. Template By <a href="https://themeforest.net/user/rajesh-doot/portfolio" target="blank">Rajesh Doot</a></p>
											</div>
										</div>
									</div>
								</div>
