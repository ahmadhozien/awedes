...
?>
<!--Start Hero-->
<section class="hero-section hero-bg-bg1 bg-gradient1 active-dark deep-dark">
			...
			<div class="row">
				<div class="col-lg-6 v-center">
					<div class="header-heading">
						...
						<a href="service_marketing" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">More Details<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
					</div>
				</div>
				<div class="col-lg-6 v-center">
	...
	<div class="container">
		...
		<div class="-cta-btn mt70">
			<div class="free-cta-title v-center  wow zoomInDown" data-wow-delay=".9s">
				...
				<a href="pricing_marketing" class="btn-main bg-btn2 lnk">Request A Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
			</div>
		</div>
	</div>
</section>
