...
?>
				...
				<div class="row">
					<div class="col-lg-5 v-center">
						<div class="hero-heading-sec2 niwax" data-rellax-speed="3">
							...
							<p class="wow fadeIn" data-wow-delay="0.4s">Niwax is one of the most creative and experienced mobile app development companies in India, we provide you with the best-in-class, industry-focused functional Mobile apps.</p>
							<div class="content-sec  d-flex mt60 v-center text-w wow fadeIn" data-wow-delay="0.6s">
								<div class="mr25"><a href="service_app" class="btn-main bg-btn4 lnk">More Details<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a></div>
		...
		<!--Start About-->
		<section class="about-sec-app pad-tb pt60">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
		...
		<!--End About-->
		<!--Start Service-->
		<section class="service-section-app pad-tb">
		...
		<section class="work-category pad-tb">
			...
			<!--End Testinomial-->
			<!--Start CTA-->
			<section class="app-cta pad-tb active-dark deep-dark">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="common-heading text-w">
