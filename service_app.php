...
<div class="bread-titlev2">
  <h1 class="wow fadeInUp" data-wow-delay=".2s">Top Rated Mobile App Development Company</h1>
  ...
  <a href="pricing" class="btn-main bg-btn2 lnk mt20 wow zoomInDown" data-wow-delay=".6s">Our Packages <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
</div>
</div>
