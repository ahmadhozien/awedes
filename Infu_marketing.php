...
?>
<!--Start Hero-->
<section class="hero-section fl-hero active-dark deep-dark">
      ...
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="header-heading">
            ...
            <a href="service_interior_marketing" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">More Details <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          </div>
        </div>
        <div class="col-lg-6 wow fadeIn" data-wow-delay=".4s"><div class="single-image"><img src="images/hero/freelancer.jpg" alt="service" class="img-fluid showin-mobile"/></div></div>
      </div>
    </div>
  </div>
</section>
